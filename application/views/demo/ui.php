					...
					<div class="box-content">
						<table class="table table-bordered table-striped">
							...
							<tr>
								<td><h3>Popover</h3></td>
								<td>
									<a href="#" class="btn btn-danger"data-trigger="hover" data-rel="popover" data-content="And here's some amazing content. It's very engaging. right?" title="A Title">Hover for popover</a>
								</td>
